...
export const momentum = {
  eyebrow: "Momentum · Sheet 02",
  section: "§ 02",
  headline: "The agentic era compounds weekly.",
  desc: "Agents, their architectures, and the harness around them are evolving faster than quarterly planning cycles can absorb. We track what ships at the frontier — and translate it into wins inside the systems you already run.",
  pillars: [
    {
      index: "01",
      label: "Agents",
      title: "Work that needed a human in the loop last quarter now runs end-to-end.",
      body: "Planning, tool-use, long-running execution — each release clears another class of task off the team's plate. What was a demo last month is a workflow this month.",
      tag: "Capability",
    },
    {
      index: "02",
      label: "Architecture",
      title: "Planners, sub-agents, reviewers, memory — systems that reason about the work.",
      body: "Multi-agent patterns turn brittle automations into layers that plan, delegate, and double-check. Less chatbot, more operator with a team behind it.",
      tag: "Pattern",
    },
    {
      index: "03",
      label: "Harness",
      title: "File access, sandboxed code, long context, MCP — the surface keeps widening.",
      body: "The harness is what turns a model into a colleague. Each month it reaches deeper into your stack — inboxes, CRMs, codebases, spreadsheets — without a rewrite underneath.",
      tag: "Surface",
    },
  ],
  stamp: {
    lead: "Frontier patterns · Your current systems",
    body: "What Anthropic, Google, OpenAI, and the frontier labs are shipping internally — adapted to your Salesforce, your ERP, your inbox. No platform rebuild. No adoption tax. Leverage that compounds where the work already lives.",
    meta: "Adopted, not imported · Built for operators",
  },
};
...
export const proof = {
  ...
  title: "GameTime",
  url: "hrs.gametime-ai.app",
  summary:
    "An AI-native sales operating layer built alongside an outbound team — research, prep, coaching, and pipeline visibility tied to the systems they already run.",
  meta: [
    { k: "Sector", v: "Commercial ops · Outbound sales" },
    { k: "Role", v: "AI audit · Workflow design · Internal product" },
    { k: "Timeline", v: "Prototype in weeks · Ongoing 2026" },
    { k: "Stack", v: "Salesforce · Twilio · OpenAI · Anthropic" },
  ],
  problem: {
    label: "01 / Before",
    title: "Talented team, talented stack — and a morning lost to research.",
    body: "An ambitious commercial team running on inboxes, spreadsheets, and tribal knowledge. Researching leads ate the morning; coaching happened after the fact; managers chased reports instead of moving deals.",
  },
  approach: {
    label: "02 / Approach",
    title: "AI where the friction is loudest, not where the demo looks best.",
    body: "We mapped the day of an SDR end-to-end, then ranked the wins by leverage. AI went where it removed the most friction first — pre-call research, queue prioritization, live coaching — without rebuilding the stack underneath.",
  },
  outcomes: [
    {
      v: "30s",
      k: "Pre-call research per lead — down from ~15 minutes of manual Googling.",
    },
    {
      v: "Wks",
      k: "From kickoff to first working prototype on live data, not slides.",
    },
    {
      v: "0",
      k: "Net-new platforms forced on the team — the AI layer sits on top.",
    },
  ],
  plates: [
    {
      tag: "Plate 06.A",
      kicker: "Module · Smart call queue",
      title: "Reps wake up to a queue, not an inbox.",
      body: "Auto-prioritized leads with fit score, temperature, and research status surfaced inline. The first dial of the day is the right one — not whichever email floated to the top.",
      img: "/assets/proof/dashboard.png",
      alt: "GameTime smart call queue with prioritized leads, fit scores, and prep buttons.",
    },
    {
      tag: "Plate 06.B",
      kicker: "Module · Manager command center",
      title: "Managers stop chasing reports. They start coaching.",
      body: "Live activity feed, qualified-lead and conversion KPIs, automation ROI, coaching queue, and AI usage in a single workspace — refreshed in real time as the team works.",
      img: "/assets/proof/manager.png",
      alt: "GameTime manager command center showing live KPIs and coaching queue.",
    },
    {
      tag: "Plate 06.C",
      kicker: "Module · AI reports hub",
      title: "Reports written by the system, not requested from it.",
      body: "Executive summary, team oversight, coaching insights, and outbound performance generated by AI on a cadence the team trusts — the manager review meeting now starts on page two.",
      img: "/assets/proof/reports.png",
      alt: "GameTime AI reports hub with executive summary and AI-generated insights.",
    },
  ],
};
